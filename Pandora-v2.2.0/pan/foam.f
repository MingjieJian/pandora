...
C---- Tells whether the I'th continuum wavelength pertains to
C     the "general" set.
C     (This is version 2 of FOAM.)
C     !DASH
      save
C     !DASH
      integer I
...
C     !BEG
      call BEECH (KONTYP(I))
C
      YES = KWKS( 1) .or. KWKS( 2) .or. KWKS( 3) .or. KWKS( 5) .or.
     $      KWKS( 6) .or. KWKS( 7) .or. KWKS( 8) .or. KWKS(12) .or.
     $      KWKS(13) .or. KWKS(15) .or. KWKS(16) .or. KWKS(17) .or.
     $      KWKS(18) .or. KWKS(19) .or. KWKS(20) .or. KWKS(21) .or.
     $      KWKS(22) .or. KWKS(23) .or. KWKS(26) .or. KWKS(27)
C     !END
      call BYE ('FOAM')
C
      return
