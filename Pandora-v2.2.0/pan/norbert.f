     ...
     $(KONTYP,USE,IS7)
C
C     Rudolf Loeser, 1995 Jun 05
C---- Determines whether the wavelength corresponding to this value of
C     KONTYP is useable for the non-LTE H- calculation.
C     !DASH
      save
C     !DASH
      integer KONTYP
...
C     !BEG
      call BEECH (KONTYP)
      IS7 = KWKS( 7)
      USE = KWKS( 2).or.KWKS( 3).or.KWKS( 5).or.KWKS( 6).or.
     $      KWKS( 7).or.KWKS( 8).or.KWKS(11).or.KWKS(12).or.
     $      KWKS(13).or.KWKS(15).or.KWKS(27)
C     !END
      call BYE ('NORBERT')
C
      return
