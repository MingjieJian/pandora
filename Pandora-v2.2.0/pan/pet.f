     ...
     $(INDEX)
C
C     Rudolf Loeser, 1984 Feb 15
C---- Sets up line source function control parameters for
C     the current (i.e. INDEX'th) transition in common block LINUS.
C     (This is version 2 of PET.)
C     !DASH
      save
C     !DASH
      integer IBRSW, ICE, IFDB, IL, ILFLX, INDEX, INKSW, IPRO, ISBG, IU,
     $        KBT, KLIN, KRT, KST, KTRN, LDL, LINT, LOML, LSFP, LSFT,
     $        METSE, METSF
C     !COM
