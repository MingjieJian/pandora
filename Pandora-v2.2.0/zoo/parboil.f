...
C     This is a common subroutine for HELENA and PARINT.
C
...
C
C---- It also returns further intermediate results in arrays D and F.
C     !DASH
      save
C     !DASH
      real*8 D, D13, D14, D24, F, S12, S23, S34, X, Y, ZERO
