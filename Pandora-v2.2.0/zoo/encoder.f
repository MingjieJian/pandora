...
C     Provides as many significant figures as possible but
C     not more than min(MAXSF,MAXTY).
C     Discards nonsignificant zeros.
C     Also returns NF, the number of characters used.
C     !DASH
c--SGK Apr 17 2009 - catch and eliminate '0X' when NB==0
      save
C     !DASH
      real*4 AVAL, EV, HNDRD, ONE, P, TEN, TENTH, THSND, VAL, ZERO
...
C
     ...
     $     0.E0,  1.E-1,  1.E0,  1.E1,  1.E2,   1.E3  /
